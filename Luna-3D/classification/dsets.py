...
def getCandidateInfoList(requireOnDisk_bool=True):
    ...
    diameter_dict = {}
    with open('/kaggle/input/luna16/luna16/luna16/annotations.csv', "r") as f:
...
class Ct:
    def __init__(self, series_uid):
        ...
        mhd_path = glob.glob(
            '/kaggle/input/luna16/luna16/luna16/subset[6-8]/subset[6-8]/{series_uid}.mhd'.format(series_uid=series_uid)
        )[0]
