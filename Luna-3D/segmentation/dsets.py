...
def getCandidateInfoList(requireOnDisk_bool=True):
    ...
    # the subsets yet.
    mhd_list = glob.glob('/kaggle/input/luna16/luna16/luna16/subset[0-4]/subset[0-4]/*.mhd')
    ...
    with open('/kaggle/input/luna16/luna16/luna16/candidates.csv', "r") as f:
        for row in list(csv.reader(f))[1:]:
            series_uid = row[0]
...
class Ct:
    def __init__(self, series_uid):
        mhd_path = glob.glob(
            '/kaggle/input/luna16/luna16/luna16/subset[0-4]/subset[0-4]/{series_uid}.mhd'.format(series_uid=series_uid)
        )[0]
